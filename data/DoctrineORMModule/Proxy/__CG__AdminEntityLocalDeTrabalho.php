 ...
 */
class LocalDeTrabalho extends \Admin\Entity\LocalDeTrabalho implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'inputFilter', 'nome');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LocalDeTrabalho $proxy) {
